...
public class SqlConstants {
    ...
    // --- Sales ---
    public static final String SALES_SELECT_TOTAL = "SELECT SUM(quantity * unit_price) FROM order_items WHERE status = ?";
    
    public static final String SALES_SELECT_DAILY = 
        "SELECT DATE(updated_at) as sales_date, SUM(quantity * unit_price) as amount, COUNT(DISTINCT o.id) as order_count " +
