...
public class SqlConstants {
    ...
    public static final String USER_INSERT =
            "INSERT INTO users (id, password, role, table_id) VALUES (?, ?, ?, ?)";
    ...
    public static final String PRODUCT_INSERT =
            "INSERT INTO products (category_id, name, price, description, allergy_info, image_path, is_available) "
            + "VALUES (?, ?, ?, ?, ?, ?, ?)";
    public static final String PRODUCT_UPDATE =
            "UPDATE products SET category_id = ?, name = ?, price = ?, description = ?, allergy_info = ?, "
            + "image_path = ?, is_available = ? WHERE id = ?";
    ...
    public static final String ORDER_ITEM_INSERT =
            "INSERT INTO order_items (order_id, product_id, quantity, unit_price, status) VALUES (?, ?, ?, ?, ?)";
